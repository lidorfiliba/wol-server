...
function handleMessage(ws, id, msg) {
  switch (msg.type) {
    ...
    case 'peerAction': {
      ...
      broadcastWorld(p.world, 'peerAction', { id, kind: msg.kind, facing: msg.facing, color: msg.color,
        sk: (typeof msg.sk==='string'?msg.sk.slice(0,14):undefined),
        el: (typeof msg.el==='string'?msg.el.slice(0,12):undefined),
        range: Math.max(0, Math.min(600, msg.range|0)) }, id);
      break;
    }
